...
export class CardSliderDirective implements AfterViewInit {
  ...
  ngAfterViewInit() {
    ...
    console.log('int ' + this.count + ' l ' + this.maxDistance)
  }
  ...
  onPanMove(e: any) {
    ...
    console.log('tt ' + this.el.nativeElement.style.transform);
  }
  ...
  private getNearestMultiple(value: any, multiple: any) {
